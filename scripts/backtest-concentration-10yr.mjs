 ...
 * Runs Top 1, 2, 3, 5, 10 for all 5 categories over 60 months (Apr 2016 – Mar 2026)
 */
...
async function main() {
  console.log("╔══════════════════════════════════════════════════════════╗");
  console.log("║  Concentration Analysis — 10 Years × 5 Categories       ║");
  console.log("║  Top 1, 2, 3, 5, 10 picks (Apr 2016 – Mar 2026)        ║");
  console.log("╚══════════════════════════════════════════════════════════╝\n");
  ...
  const scanDates = genDates(2016,3,2026,2); // Apr 2016 – Mar 2026
  console.log(`Scan dates: ${scanDates.length} months\n`);

  // Nifty benchmark
  const nStart = niftyBars.find(b=>b.date>=new Date("2016-04-01"))?.close;
  ...
  // Print results
  console.log(`\n${"═".repeat(90)}`);
  console.log("  10-YEAR CONCENTRATION TABLE (₹2L starting capital, Apr 2016 – Mar 2026)");
