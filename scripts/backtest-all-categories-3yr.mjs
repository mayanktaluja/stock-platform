#!/usr/bin/env node
/**
 * ALL 5 CATEGORIES -- 3-Year Paper Trading Simulation
 * =====================================================
 *
 * Comprehensive head-to-head comparison of ALL 5 pick categories with
 * independent capital pools (Rs 2,00,000 each = Rs 10,00,000 total).
 *
 * Categories:
...
const REPORT_PATH = path.join(REPORT_DIR, "all-categories-3yr-report.md");
